...
public class RestaurantMessagingDataMapper {
    ...
    public RestaurantApprovalResponseAvroModel orderApprovedEventToRestaurantApprovalResponseAvroModel(OrderApprovedEvent orderApprovedEvent) {
        return RestaurantApprovalResponseAvroModel.newBuilder()
                ...
                .setSagaId("")
                .setOrderId(orderApprovedEvent.getOrderApproval().getId().getValue().toString())
    ...
    restaurantApprovalRequestAvroModelToRestaurantApproval(RestaurantApprovalRequestAvroModel
        ...
        return RestaurantApprovalRequest.builder()
                ...
                .restaurantId(restaurantApprovalRequestAvroModel.getSagaId())
                .orderId(restaurantApprovalRequestAvroModel.getOrderId())
                .restaurantOrderStatus(com.food.ordering.system.domain.valueobject.RestaurantOrderStatus.valueOf(restaurantApprovalRequestAvroModel
